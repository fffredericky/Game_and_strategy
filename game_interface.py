...
# import interactive_strategy, random_strategy
import strategy
from typing import Any, Callable
# import SubtractSquareGame and ChopsticksGame
import game
# import SSGstate and CGState
import game_state_checker
...
# to Chopsticks.
playable_games = {'s': game.SubtractSquareGame,
                  'c': game.ChopsticksGame}

# The strategies you are to implement.  See strategy.py, and then decide
# how to modify this.
usable_strategies = {'r': strategy.random_strategy,
                     'i': strategy.interactive_strategy}
